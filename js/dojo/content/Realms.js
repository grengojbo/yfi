     ...
     cr.add  = function(){
        ...
        var dlgAdd  = new dijit.Dialog({
            ...
            var frmAdd    = new dijit.form.Form({ encType:"multipart/form-data",action:"",method:"POST"},document.createElement("div"));
                ...
                components.QElements.addTextArea({label:tr.tr({'module': 'Realms','phrase':"Address",'lang':l}),  divToAdd: frmAdd.domNode,inpName:'Address',     inpRequired:false, isLast:true});
