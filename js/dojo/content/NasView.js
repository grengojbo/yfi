...
(function(){
    ...
    function populateNasOptional(divContainer,nas){
        ...
        components.QElements.addPair({      label:tr.tr({'module': 'NasView','phrase':"Latitude",'lang':l}),  divToAdd: frmEdit.domNode,  inpName:'lat',    inpRequired:false,  isLast:true,   value: nas.lat});
