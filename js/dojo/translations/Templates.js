...
(function(){
    ...
    translations.Templates.phrases     = {
        ...
        'Check Attribute Count':{ 
            'de_DE' : '&Uuml;perpr&uuml;fe gezahlte Attribute',	      
        ...
        'Add Profile Template':{ 
            'de_DE' : 'Profil Vorlage hinzuf&uuml;gen',	      
	  ...
	  'Available to all': {
        ...
        'Profile Template added OK':{
            'de_DE' : 'Profilvorlage hinzugef&uuml;gt',	      
        ...
        'Problems adding Profile Template':{ 
            'de_DE' : 'Problem beim hinzuf&uuml;gen Profilvorlage',	      
        ...
        'Problems removing Template(s)':{ 
            'de_DE' : 'Problem beim entfernen der Vorlage',	      
